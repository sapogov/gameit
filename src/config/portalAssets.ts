...
export const portalImageAssets: Record<PortalImageAssetKey, PortalImageAsset> = {
  ...
  'portal-cover-flappy-bird': {
    ...
    role: 'cover',
    src: '/assets/portal/flappy-bird-cover.svg',
  ...
  'portal-hero-flappy-bird': {
    ...
    role: 'hero',
    src: '/assets/portal/flappy-bird-hero.svg',
  ...
  'portal-cover-stickman-fight': {
    ...
    role: 'cover',
    src: '/assets/portal/stickman-fight-cover.svg',
  ...
  'portal-hero-stickman-fight': {
    ...
    role: 'hero',
    src: '/assets/portal/stickman-fight-hero.svg',
