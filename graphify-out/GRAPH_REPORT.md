# Graph Report - issue-63  (2026-07-20)

## Corpus Check
- 140 files · ~327,221 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1339 nodes · 3576 edges · 69 communities (58 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4232999f`
...
Cohesion: 0.10
Nodes (33): attemptFacingFarmTheft(), clearFarmGuard(), collectFacingFarm(), createFarmTheftLogEntry(), FarmCollectionFailureReason, FarmCollectionResult, FarmDefinition, farmDefinitions (+25 more)
...
Cohesion: 0.16
Nodes (13): checkGen1SpeciesCatalog(), attackPoolIds, capitalize(), createPlaceholderSpecies(), creatureRarities, creatureTypes, getPlaceholderAttackPools(), getPlaceholderRarity() (+5 more)
...
Cohesion: 0.13
Nodes (27): addItem(), createItemInventory(), discardItem(), InventoryResult, ItemInventory, ItemStack, requiredAdditionalSlots(), getItemDefinition() (+19 more)
...
Cohesion: 0.08
Nodes (42): toLocationRoomState(), isValidCreatureContainerLayout(), getMapById(), isMapId(), hasUnsupportedSchemaVersion(), hasValidLegacyCurrencies(), isAvatarId(), isBooleanRecord() (+34 more)

### Community 19 - "Community 19"
Cohesion: 0.11
Nodes (24): MultiplayerConnection, avatarIds, cleanupExpiredTransitions(), consumePendingTransition(), createPendingTransition(), directions, generatedRoute, generatedTown (+16 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (62): assertBalanceVersion(), BattleRoom, copyBattleStateToSchema(), toAttackSchema(), toBattleStateSchema(), toCreatureSchema(), toParticipantSchema(), BattleAttackSchema (+54 more)
...
Cohesion: 0.10
Nodes (25): isFarmGuardActive(), isFarmGuardBlockingTheft(), getNextPlayerLevelThreshold(), MovementResult, StationDestination, CardRow, CreatureRow, FarmRow (+17 more)
...
Cohesion: 0.17
Nodes (7): setCreatureHp(), assignFarmGuard(), consumeFarmCardRequirements(), consumeMaterialRequirements(), getFarmUpgradePlan(), getFarmUpgradePreview(), upgradeFarm()
...
Cohesion: 0.21
Nodes (13): checkCreatureJournalStates(), WILD_BATTLE_REWARD_TABLES, createProfileState(), assertKnownSpecies(), getJournalSpeciesViewState(), recordCreatureDiscovered(), recordWildCreatureSeen(), withJournalSpeciesState() (+5 more)
...
Cohesion: 0.10
Nodes (36): CardRewardTable, canCreatureUseRole(), CreaturePartyFailureReason, CreaturePartyResult, CreatureUseRole, healAllCreaturesAtHospital(), isCreatureFainted(), moveCreatureToActiveParty() (+28 more)

### Community 30 - "Community 30"
Cohesion: 0.24
Nodes (5): LocationPlayerSchema, LocationStateSchema, WildEncounterSchema, MapKind, WildEncounterStatus
...
Cohesion: 0.25
Nodes (10): bootGame(), MonsterRpgGameRuntime, getGeneratedMapForClient(), checkInitialSaveStartsInHomeVillage(), getGeneratedMapForServer(), toSquareGridMap(), getGameMap(), moveOnSquareGrid() (+2 more)
...
Cohesion: 0.22
Nodes (13): checkBlockedMovement(), checkBuildingEntryAndExit(), checkHomeVillageEastGateExit(), checkOverworldVillageEntry(), createState(), findPath(), findPathToAdjacentFacing(), SquareGridMapAdapter (+5 more)
...
Cohesion: 0.31
Nodes (7): BootGameOptions, defaultMonsterRpgSettings, loadMonsterRpgSettings(), MonsterRpgSettings, normalizeSettings(), saveMonsterRpgSettings(), CreatureLabelMode
...
Cohesion: 0.13
Nodes (3): loadMonsterRpgFonts(), VillageScene, FarmSaveRecord
...
- **Why does `VillageScene` connect `Community 71` to `Community 64`, `Community 65`, `Community 66`, `Community 35`, `Community 70`, `Community 42`, `Community 47`, `Community 21`, `Community 54`, `Community 30`, `Community 63`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `MonsterRpgSaveState` connect `Community 65` to `Community 1`, `Community 4`, `Community 9`, `Community 12`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 27`, `Community 28`, `Community 29`, `Community 42`, `Community 44`, `Community 48`, `Community 63`, `Community 70`, `Community 71`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `CURRENT_BALANCE_VERSION` connect `Community 20` to `Community 3`, `Community 11`, `Community 48`, `Community 18`, `Community 19`, `Community 23`, `Community 27`, `Community 29`?**
