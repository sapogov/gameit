...
## Corpus Check
- 136 files · ~323,571 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1298 nodes · 3455 edges · 73 communities (63 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `004e7dfc`
...
Cohesion: 0.10
Nodes (26): applyInteriorTemplate(), buildingDefinitions, buildingNames, buildingTiles, createInteriorMap(), createInteriorSpawn(), createVillageMap(), createWorldMap() (+18 more)

### Community 1 - "Community 1"
Cohesion: 0.13
Nodes (33): sanitizeBattleCreature(), createWildBattleCreature(), hashString(), attackByPoolId, consumeRequirements(), convertCreatureCardViaElder(), createCreatureCardInstance(), createCreatureRecord() (+25 more)
...
Cohesion: 0.07
Nodes (34): BalanceVersionMismatchError, BattleConnection, BattleConnectionHandlers, ColyseusRoom, ConnectionHandlers, connectRoomLifecycle(), connectToBattle(), connectToLocation() (+26 more)

### Community 4 - "Community 4"
Cohesion: 0.11
Nodes (20): clearFarmGuard(), FarmCollectionFailureReason, FarmCollectionResult, farmDefinitions, FarmGuardAssignmentResult, FarmGuardFailureReason, FarmTheftAttemptResult, FarmTheftFailureReason (+12 more)
...
Cohesion: 0.09
Nodes (36): activateBuffCard(), activateMaterialCard(), BuffCardDefinition, buildFarmCardViaElder(), CARD_PACK_RARITY_TIERS, CardActionResultReason, cardBuffTypes, CardDefinition (+28 more)
...
Cohesion: 0.15
Nodes (22): addItem(), createItemInventory(), discardItem(), InventoryResult, ItemInventory, ItemStack, requiredAdditionalSlots(), canonicalDefinitions (+14 more)

### Community 12 - "Community 12"
Cohesion: 0.15
Nodes (11): activateCreatureCardViaElder(), getCardCatalog(), getCreatureCardById(), createProfileState(), getEggDescription(), healAllCreaturesAtHospital(), moveCreatureToActiveParty(), moveCreatureToStorage() (+3 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (53): attr(), canonicalPinnedSourceLocation(), convertMapSet(), convertTmx(), facing(), geometry(), hasUriText(), hasUriValue() (+45 more)
...
Cohesion: 0.16
Nodes (14): checkGen1SpeciesCatalog(), attackPoolIds, capitalize(), createPlaceholderSpecies(), creatureRarities, creatureTypes, getPlaceholderAttackPools(), getPlaceholderRarity() (+6 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (7): getInitialState(), MonsterRpgGame(), moveDeltaByDirection, isAtVillageHospital(), clearProgress(), loadProfile(), loadSaveResult
...
Cohesion: 0.07
Nodes (53): checkSaveReset(), isItemId(), exportSave(), hasUnsupportedSchemaVersion(), importSavePayload(), isAvatarId(), isBooleanRecord(), isCardBuffRecord() (+45 more)

### Community 19 - "Community 19"
Cohesion: 0.11
Nodes (22): MultiplayerConnection, avatarIds, cleanupExpiredTransitions(), consumePendingTransition(), createPendingTransition(), directions, generatedRoute, generatedTown (+14 more)

### Community 20 - "Community 20"
Cohesion: 0.17
Nodes (23): abandonDisconnectedBattle(), advanceAfterEnemyAction(), appendBattleLog(), applyAttack(), BattleActionResult, canUseBattleAttack(), chooseEnemyAttack(), choosePlayerBattleAttack() (+15 more)
...
Cohesion: 0.11
Nodes (22): FarmUpgradePlan, getNextPlayerLevelThreshold(), CardRow, CreatureRow, FarmRow, formatBattleStatus(), formatBlockedBy(), formatCurrencySummary() (+14 more)
...
Cohesion: 0.15
Nodes (10): BattleAttackSchema, BattleCreatureSchema, BattleLogEntrySchema, BattleParticipantSchema, BattleStateSchema, BattleStatsSchema, BattleParticipantKind, BattleStatus (+2 more)
...
Cohesion: 0.18
Nodes (20): getVillageDefinition(), isValidStation(), confirmStationTravel(), createInitialStationContainer(), createPlayerVillageStationDestination(), discoverCurrentStationDestination(), discoverPlayerVillageForStation(), getDefaultVillageStationLevel() (+12 more)

### Community 28 - "Community 28"
Cohesion: 0.10
Nodes (37): CreaturePartyFailureReason, CreaturePartyResult, CreatureUseRole, isCreatureFainted(), isValidCreatureContainerLayout(), useReviveItem(), FarmDefinition, AttackPoolId (+29 more)
...
Cohesion: 0.20
Nodes (15): PendingTransition, LocationTransition, MapId, WorldPosition, canTargetEncounter(), clamp01(), createWildEncounterSpawn(), EncounterRng (+7 more)
...
Cohesion: 0.22
Nodes (17): resolveJoinPosition(), checkBlockedMovement(), checkBuildingEntryAndExit(), checkHomeVillageEastGateExit(), checkInitialSaveStartsInHomeVillage(), checkOverworldVillageEntry(), createState(), findPath() (+9 more)
...
Cohesion: 0.26
Nodes (10): assertBalanceVersion(), copyBattleStateToSchema(), toAttackSchema(), toBattleStateSchema(), toCreatureSchema(), toParticipantSchema(), getBattleAttackFatigueCost(), resumeDisconnectedBattle() (+2 more)

### Community 51 - "Community 51"
Cohesion: 0.18
Nodes (8): setCreatureHp(), collectFacingFarm(), consumeFarmCardRequirements(), consumeMaterialRequirements(), getAccruedFarmRecord(), getFarmStoredQuantity(), getFarmUpgradePreview(), upgradeFarm()

### Community 52 - "Community 52"
Cohesion: 0.20
Nodes (6): assertBalanceVersion(), LocationRoom, sanitizeProfile(), JoinLocationOptions, getWildEncounterZonesForMap(), zone()
...
Cohesion: 0.36
Nodes (10): attemptFacingFarmTheft(), createFarmTheftLogEntry(), getFarmTheftAttemptCost(), getFarmTheftCooldown(), getFarmTheftCooldownKey(), getFarmTheftStolenQuantity(), getFarmTheftSuccessChance(), getTargetVillageLevel() (+2 more)
...
Cohesion: 0.29
Nodes (6): BattleRoom, markBattleClaimResolved(), gameServer, port, markBattleDisconnected(), BattleRoomState
...
Cohesion: 0.18
Nodes (16): bootGame(), BootGameOptions, MonsterRpgGameRuntime, getGeneratedMapForClient(), VillageSceneOptions, ApplyBattleRewardsResult, CardActionResult, OpenPackResult (+8 more)

### Community 72 - "Community 72"
Cohesion: 0.50
Nodes (4): sanitizeGuardCreature(), canCreatureUseRole(), assignFarmGuard(), isFarmGuardActive()
...
- **Why does `VillageScene` connect `Community 35` to `Community 64`, `Community 66`, `Community 69`, `Community 70`, `Community 7`, `Community 71`, `Community 44`, `Community 21`, `Community 54`, `Community 28`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `MonsterRpgSaveState` connect `Community 70` to `Community 0`, `Community 1`, `Community 4`, `Community 9`, `Community 12`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 27`, `Community 28`, `Community 29`, `Community 35`, `Community 48`, `Community 53`, `Community 64`, `Community 65`?**
